        ...
        <nav class="navbar bg-dark fixed-top navbar-expand-lg py-3 shadow">
            <div class="container-fluid">
                <div class="navbar-brand d-inline-block align-text-top">
                    ...
                    <span class="text-white fw-bold h5" style="letter-spacing: 1.2px;"> CHECKLIST TOILET</span>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-sm-9 col-md-10 button-ubah">
                            <button type="submit" name="ubah_checklist"
                                class="btn btn-outline-secondary form-control text-uppercase mt-4">Ubah Data</button>
                        </div>
                    </div>
                </form>
            </div>

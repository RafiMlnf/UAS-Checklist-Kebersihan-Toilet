            ...
            <div class="card-body p-5">
                        ...
                        <form action="tambah.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6 col-sm-4 col-md-10">
                                    <button type="submit" name="tambah_toilet" class="btn btn-outline-secondary form-control text-uppercase mt-3">Tambah</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div id="laporanToilet" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col">
                                <a href="laporan.php?toilet" class="btn btn-outline-secondary px-4 me-2">Semua Data</a>

...
<body>
    <div class="container-fluid">
        <!-- Navbar -->
        <nav class="navbar bg-dark fixed-top navbar-expand-lg py-3 shadow">
            <div class="container-fluid">
                <div class="navbar-brand d-inline-block align-text-top">
                    <i class="fa-solid fa-check-to-slot me-2" style="color: #ffffff;"></i>
                    <span class="text-white fw-bold h5" style="letter-spacing: 1.2px;"> CHECKLIST KEBERSIHAN TOILET</span>
                </div>
        ...
        <div class="modal" id="logout">
            <div class="modal-content">
                ...
                <div class="d-flex justify-content-end">
                    <button id="btn-ya" class="btn btn-outline-secondary px-4 me-2">Ya</button>
            ...
            <div class="card-body p-5">
                    ...
                    <div class="col-sm-4">
                        ...
                        <form method="GET" class="mb-4">
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-outline-secondary rounded-start px-4"><i class="fa-solid fa-magnifying-glass me-2"></i>Cari</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form action="tambah.php" method="POST" enctype="multipart/form-data" class="form-tambah">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6 col-sm-3 col-md-10">
                                    <button type="submit" name="tambah_checklist" class="btn btn btn-outline-secondary form-control text-uppercase mt-3">Tambah</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div id="laporanChecklist" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-outline-secondary px-4 me-2" onclick="inputTanggal()">Tanggal</button>
                                <button class="btn btn-outline-secondary px-4 me-2" onclick="pilihBagian()">Rusak/Kotor</button>
                            </div>
                        </div>
                        <form id="tanggalForm" method="GET" action="laporan.php" class="mt-4" style="display: none;">
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-outline-secondary rounded-start px-4">Buat</button>
                            </div>
                        </form>
    ...
    <footer class="bg-dark text-white py-3" style="margin-top: 68px;">
    <div class="container-fluid text-center">
        &copy; <?php echo date('Y'); ?> - Kelompok 8 - Checklist Kebersihan Toilet
    </div>
    </footer>
